...
class ComponentViewModel: ObservableObject {
    @Published private(set) var components: [Component] = [
        ...
        Component(title: "Inset", type: .list, systemImageName: "photo.artframe", documentationURL: URL(string: "https://developer.apple.com/documentation/swiftui/list")!),
        ...
        Component(title: "Inset Grouped", type: .list, systemImageName: "square.split.2x2", documentationURL: URL(string: "https://developer.apple.com/documentation/swiftui/list")!),
